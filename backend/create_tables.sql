...
CREATE TABLE IF NOT EXISTS listings (
    ...
    image_url VARCHAR(1000) NULL COMMENT '매물 메인 이미지 URL',
    sub_image_url_1 VARCHAR(1000) NULL COMMENT '서브 이미지 1',
    sub_image_url_2 VARCHAR(1000) NULL COMMENT '서브 이미지 2',
    sub_image_url_3 VARCHAR(1000) NULL COMMENT '서브 이미지 3',
...
CREATE TABLE IF NOT EXISTS clause_analysis_results (
  ...
  mediation_summaries LONGTEXT NULL,
  mediation_case_ids  JSON NULL,
  precedent_summaries LONGTEXT NULL,
  precedent_case_ids  JSON NULL,
  precedent_evidence  JSON NULL,
  law_summaries       LONGTEXT NULL,
  law_ids             JSON NULL,
